...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Oğuz Korkut", "oguzkorkut.com", "oguzkrkt@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("API Title", "Api Documentation", "1.0",
